# Diario sessione — Capitolo [NUMERO] — [Titolo breve]

| Campo | Valore |
|-------|--------|
| **Modulo** | M04 — NLP, Embeddings & Transformers |
| **File capitolo** | `NN_nome_file.py` |
| **File diario** | `M04_CNN_nome_file_sessione.md` |
| **Stato** | in corso / chiuso (data) |
| **Voto difficoltà** | — / X/10 |
...
> - Append-only: non riscrivere le entry precedenti.

### [YYYY-MM-DD] — Riferimento
