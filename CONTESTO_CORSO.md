...
| Campo | Valore |
|-------|--------|
| **Capitolo in corso** | modulo_03_dl_cv/01_neurone_artificiale.py — **CREATO 07/05/2026** — Neurone artificiale = layer Dense con h=1 + sigmoid; rinforzo lacuna #26 🟡; lacune quiz ingresso #23/#28/#24/#29/#27 🟢 (07/05/2026) + recall Ponte cap.02. |
...
| **Priorità attive** | 🟡 Lacuna quiz #26: `X @ w` vs loop — secondo motivo distinto (overhead ciclo / cache / SIMD) da consolidare; 🟡 Pattern #6 consegne (monitoraggio), 🟡 Pattern #19 terminologia None vs null, 🟡 Pattern #21 tupla/round (monitoraggio), 🟡 Data leakage (monitoraggio). |
...
| **Rinforzi da inserire (🔁)** | 🔁 Lacuna #26 (2° motivo BLAS vs loop: overhead/Python/cache). |
| **Concetti ⚠️ da ripassare** | Logits→probabilità (sigmoid/softmax), broadcasting del bias, shape nei batch. |
| **Pattern 🔴 da monitorare** | #6 consegne (DoD), #19 terminologia None vs null, #21 round/tuple, lacuna quiz #26. |
