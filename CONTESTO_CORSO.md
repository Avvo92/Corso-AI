...
| Campo | Valore |
|-------|--------|
| **Capitolo in corso** | modulo_03_dl_cv/01_neurone_artificiale.py — **CREATO 07/05/2026** — Neurone artificiale = layer Dense con h=1 + sigmoid; rinforzi mirati lacune #26/#27/#29 (lacune #23 Q1, #28 Q2, #24 Q3 🟢 07/05/2026) + recall cross-modulo verso Ponte cap.02. |
...
| **Priorità attive** | 🔴 Lacuna quiz #26: 2 motivi performance BLAS vs loop; 🔴 Lacuna quiz #27: Feynman rispettare “niente termini tecnici”; 🟡 Lacuna quiz #29: slicing `X[i]` (1D) vs `X[i:i+1]` (2D) (rinforzata); 🟡 Pattern #6 consegne (monitoraggio), 🟡 Pattern #19 terminologia None vs null, 🟡 Pattern #21 tupla/round (monitoraggio), 🟡 Data leakage (monitoraggio). |
...
| **Rinforzi da inserire (🔁)** | 🔁 Lacuna #26 (2 motivi performance BLAS vs loop); 🔁 Lacuna #27 (Feynman “solo analogia”); re-check #29 slicing 1D vs 2D. |
