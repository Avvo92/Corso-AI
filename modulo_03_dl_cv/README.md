...
| 07 | `07_pytorch_intro.py` 🟢 **pronto** (creato 03/08/2026) | Tensori, autograd, `nn.Module`, Dataset/DataLoader, training loop, `state_dict` + 🔁 residui cap.06 (#42/#43/#27, drift, confronto). **Google Colab** (GPU). | 7–8/10 | Colab |
