...
| 09 | `09_transfer_learning.py` *(segnaposto + blocco rinforzi da chiusura C08)* | Transfer learning con ResNet pre-addestrata + script `anonimizza_buste.py` + setup dataset reale (200 buste paga anonimizzate + 200 "altro"). Prerequisiti privacy da verificare prima di iniziare. | 7/10 | Colab |
